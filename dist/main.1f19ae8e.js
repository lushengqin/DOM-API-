...
var testDiv = dom.find('#test')[0]; //querySelectorAll获取 记得加[0] 不然获取不到

console.log(testDiv); //如果有两个类名为red的参数 父元素不同
...
console.log(dom.previous(tutu)); // each 配合find一起使用
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11530" + '/');
